            ...
            <div id="conteudo" class="row conteudo-principal " style="height: 944px;">
                <div class="col-md-12">
                    <div class="row col-md-offset-3">
                        <h2 class="title-box">Cadastrar Localização</h2>
                    </div>
                    <div class="row form col-md-6 col-md-offset-3">
                        <form action="./index?action=post" method="POST">
                            <div class="row">
                                ...
                                <div class="form-group field-form">
                                    <label for="palavrasChaves" style="display: block">Palavras Chaves:</label>
                                    <input type="text" name="palavrasChaves" class="form-control" id="palavrasChaves" data-role="tagsinput">
                                </div>
                            </div>
                            <div class="row">
