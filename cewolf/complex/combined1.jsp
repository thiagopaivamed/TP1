...
<TR>
<TD>
<cewolf:combinedchart id="test2" layout="horizontal" title="LG European Index Trust (with moving average)" type="combinedxy" yaxislabel="y-values">
    <cewolf:colorpaint color="#AAAAFF"/>
		<cewolf:plot type="xyverticalbar" xaxislabel="x-values">
			<cewolf:data>
      			<cewolf:producer id="xy1" />
    		</cewolf:data>
		</cewolf:plot>

		<cewolf:plot type="xyline" xaxislabel="x-values">
			<cewolf:data>
