...
if (pageContext.getAttribute("initFlag") == null) {
  ...
  pageContext.setAttribute("xyData", xyData);
	...
	// just like xyData above, but with fewer values
  DatasetProducer histogramData = new DatasetProducer() {
    public Object produceDataset(Map params) {
      XYSeries xys = new XYSeries("Example Histogram Dataset");
      double last = 0.0;
      for (int i = 0; i < 12; i++) {
        double y = last + ((Math.random() * 100) - 50.0);
        xys.add((double) i, y);
    ...
    public String getProducerId() {
      return "HistogramDataProducer";
    }
    public boolean hasExpired(Map params, Date since) {
      return false;
    }
  };
  pageContext.setAttribute("histogramData", histogramData);

  DatasetProducer xyzData = new DatasetProducer() {
    public Object produceDataset(Map params) {
		DefaultXYZDataset xyzDS = new DefaultXYZDataset();
		double[] ds = { 2.1, 2.3, 2.3, 2.2, 2.2, 3.8, 3.3, 2.9, 2.3, 4.8 };
		double[] ds_1_ = { 14.1, 11.1, 10.0, 8.8, 8.7, 8.4, 5.4, 4.1, 4.1, 20.0 };
		double[] ds_2_ = { 2.4, 2.7, 2.7, 2.2, 2.2, 2.2, 2.1, 2.2, 1.6, 4.0 };
		double[][] ds_3_ = { ds, ds_1_, ds_2_ };
		xyzDS.addSeries("Some bubbles", ds_3_);
		return xyzDS;
    }
    public String getProducerId() {
  ...
  pageContext.setAttribute("xyzData", xyzData);
  ...
  DatasetProducer hiloData = new DatasetProducer() {
    public Object produceDataset(Map params) {
      ...
      OHLCDataset ds = new DefaultHighLowDataset("Laures, Inc.", dates, high, low, open, close, volume);
      return ds;
    }
    public String getProducerId() {
  ...
  ToolTipGenerator xyTTG = new XYToolTipGenerator() {
    public String generateToolTip(XYDataset arg0, int series, int arg2) {
      return "Series " + series + ", item " + arg2;
    }
  };
  pageContext.setAttribute("xyToolTipGenerator", xyTTG);
...
<TD>
colorpaint<BR>
<cewolf:chart id="timeChart" title="TimeSeries" type="timeseries" plotbordercolor="#FF0000">
...
<TD>
colorpaint with alpha blending and link map<br>
...
<cewolf:img chartid="XYChart" renderer="/cewolf" width="300" height="300">
  <cewolf:map linkgeneratorid="xyLinkGenerator" tooltipgeneratorid="xyToolTipGenerator"/>
</cewolf:img>
</TD>
</TR>
<TR>
<TD>
gradientpaint acyclic; drop shadow removed<br>
...
<cewolf:img chartid="stackedHorizontalBar3D" renderer="/cewolf" width="300" height="300"/>
</TD>
</TR>
...
<cewolf:chart id="lineChart" title="LineChart" type="line" xaxislabel="Fruit" yaxislabel="favorite">
    ...
    <cewolf:chartpostprocessor id="seriesPaint">
        ...
        <cewolf:param name="2" value="#FFAAFF"/>
        <cewolf:param name="3" value="#FFAAAA"/>
        <cewolf:param name="4" value="#FFAA00"/>
    </cewolf:chartpostprocessor>
</cewolf:chart>
...
<TD>
Histogram<br>
<cewolf:chart id="histogram" title="Histogram" type="histogram">
    <cewolf:data>
        <cewolf:producer id="histogramData" />
    </cewolf:data>
</cewolf:chart>
<cewolf:img chartid="histogram" renderer="/cewolf" width="300" height="300" />
</TD>
<TD>
Bubble<br>
<cewolf:chart id="bubble" title="Bubbles" type="bubble">
    <cewolf:data>
        <cewolf:producer id="xyzData" />
    </cewolf:data>
</cewolf:chart>
<cewolf:img chartid="bubble" renderer="/cewolf" width="300" height="300" />
</TD>
</TR>
